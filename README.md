...
```hcl
github.com/pbs/terraform-aws-synthetics-module?ref=2.0.4
```
...
```hcl
module "synthetics" {
  source = "github.com/pbs/terraform-aws-synthetics-module?ref=2.0.4"
...
| <a name="module_s3"></a> [s3](#module\_s3) | github.com/pbs/terraform-aws-s3-module | 4.0.3 |
